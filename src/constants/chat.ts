...
export const randomHints = [
	...
	'У меня конфликт на работе',
	'Трудно воспитывать ребенка',
	'Умер близкий человек',
	'Я не сдал экзамен',
	'У меня проблемы с жильем',
	'Я выгорел на работе',
	...
	'У нас с партнером кризис',
	'У ребенка проблемы в школе',
	'Я не могу найти работу',
	'У меня проблемы в бизнесе',
	'Меня обманули',
	'Не могу избавиться от долгов',
	'Разбил машину',
	'Мне надо найти новое жилье',
	'Не могу найти любовь',
	'У меня конфликт в семье',
	'У меня часто бывает тревога',
	'У меня панические атаки',
	'У меня синдром самозванца',
	'Я часто откладываю дела',
	'Я боюсь не сдать экзамен',
];
...
export const furtherActionsList = [
	'Очень важно для достижения результата',
...
export const exerciserCardsList = [
	'Как работает виртуальный тренажер?',
	'Главная цель виртуального тренажера — помочь вам научиться заменять автоматические негативные мысли на более адаптивные и конструктивные.',
	'Что надо делать?',
	'Сначала Мира покажет вам короткий сценарий из реальной жизни человека, в котором будет выделена автоматическая негативная мысль.',
	'Читая эти истории, подумайте, какая новая мысль может помочь человеку чувствовать себя лучше в описанной ситуации.\nПосле этого напишите ее и отправьте в чат.',
	'Новая мысль будет проверена Мирой, чтобы убедиться, что она соответствует стандартам психологической безопасности в рамках когнитивно-поведенческой терапии.',
	'Если новая мысль не соответствует критериям, то Мира укажет на недостатки и предложит попробовать снова.\nУ вас будет еще 2 попытки.',
	'Это бесплатно?',
	'На данный момент вы можете проработать 4 сценария в месяц абсолютно бесплатно, если у вас есть хотя бы 1 сессия на балансе аккаунта.\nУдачи!',
];
